...
interface IAnonAadhaarRecoveryManager {
    /*//////////////////////////////////////////////////////////////////////////
                                TYPE DELARATIONS
    //////////////////////////////////////////////////////////////////////////*/
    ...
    event GuardianAccepted(address indexed account, uint indexed guardian);
    ...
    function addGuardian(uint guardian, uint256 weight) external;

    function removeGuardian(uint guardian) external;
